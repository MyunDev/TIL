...
var server1 = ["김현기", "민승원", 43, null, true];          // 배열 리터럴을 이용하는 방법
var server2 = Array("윤지원", "신한빈", 13);     // Array 객체의 생성자를 이용하는 방법
var server3 = new Array("주원철", "임태영", false, undefined); // new 연산자를 이용한 Array 객체 생성 방법
