...
console.log('sopt : ', sopt);
console.log('sopt :' + JSON.stringify(sopt)); // Javscript 객체를 문자열로 변환
...
console.log('dogs : ', dogs);
console.log('dogs :' + JSON.stringify(dogs)); // Javscript 객체를 문자열로 변환
...
//https://velog.io/@solmii/TIL-JSON%EC%9D%B4%EB%9E%80 참고 링크 (JSON 관련 설명)